...
axios.get('https://api.github.com/users/JusticeMatthew')
  .then(result => {
    const myCard = cardMaker(result);
    document.querySelector('.cards').prepend(myCard); // I did prepend so I come first ;)
  })
